        ...
        <div class="card card-custom my-5">
            ...
            <div class="card-header border-0 pt-7">
                <h3 class="card-title align-items-start flex-column">
                    <span class="card-label font-weight-bolder font-size-h4 text-dark-75">All Events</span>
                </h3>
            </div>
            <!--end::Header-->
            <!--begin::Body-->
                            ...
                            <table class="table table-borderless table-vertical-center">
                                <thead>
                                    <tr class="text-center">
                                        ...
                                        <th class="p-0 min-w-100px">Location</th>
                                ...
                                @forelse($events as $event)
                                    <tr class="text-center">
                                        <td class="px-5" >
                                            <a href="#" class="text-dark-75 text-hover-primary mb-1 font-size-lg" >{{ $event->id }}</a>
                                        </td>
                                        <td style="padding:15px 100px;">
                                                <img src="{{ $event->image }}" alt="" style="width: 50px; height: 50px; object-fit:cover; border-radius: 20%;">
                                        </td>
                                        <td style="padding:15px 50px;">
                                            <a href="#" class="text-dark-75 text-hover-primary mb-1 font-size-lg">{{ $event->name }}</a>
                                        </td>
                                        @php
            ...
            swal({
                ...
                .then((willDelete) => {
                    if (willDelete) {
                        ...
                        swal("The event has not been deleted!");
                    }
                });
        });
    </script>
