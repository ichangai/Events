                ...
                <div class="card-body">
                    ...
                    <div class="">
                        ...
                        <div class="bgi-no-repeat bgi-size-cover rounded"
                            style="background-image: url({{ asset('storage/images/'. $event->image)}}); height: 200px; width: 100%;"></div>
                        <!--end::Image-->
                        <!--begin::Location-->
...
<div style="display:flex; justify-content:center; align-items:stretch; padding: 300px 0;">
        <h3 style="color: rgba(128, 128, 128, 0.63);" >No conferences available</h3>
</div>
@endforelse
@endsection
