...
@section('content')
    @forelse ($awards as $event)
        <div class="row" style="margin: 50px 0;">
            <div class="col-xl-4 col-lg-3 col-md-4 col-sm-4" style="border-radius: 20px;">
                <!--begin::Mixed Widget 6-->
                <div class="card card-custom gutter-b card-stretch">
                    <!--begin::Header-->
                    <div class="card-header border-0 pt-6">
                        <h3 class="card-title align-items-start flex-column">
                            <span class="card-label font-weight-bolder font-size-h4 text-dark-75">Event Name:
                                {{ $event->name }}</span>
                            @php
                    ...
                    <div class="card-body">
                        ...
                        <div class="">
                            ...
                            <div class="bgi-no-repeat bgi-size-cover rounded"
                                style="background-image: url({{ asset('storage/images/' . $event->image) }}); height: 200px; width: 100%;">
                            </div>
                            <!--end::Image-->
                            <!--begin::Location-->
                            <h4 class="text-dark-75 text-hover-primary font-weight-bold pt-6" style="font-size: 14px;">
                                Location:
                                {{ $event->location }}</h4>
                            <!--end::Location-->
                            ...
                            <div class="pt-2"
                                ...
                                <form action="{{ route('admin.event.delete', $event->id) }}" method="post"> @csrf
                                    @method('delete') <a type="submit"
                                        class="dltBtn btn btn-primary font-weight-bolder py-2" data-id="">Delete</a>
                                </form>
                            </div>
                        </div>
                        <!--end::Container-->
    ...
    @empty
        <div style="display:flex; justify-content:center; align-items:stretch; padding: 300px 0;">
            <h3 style="color: rgba(128, 128, 128, 0.63);">No awards available</h3>
        </div>
    @endforelse
@endsection
