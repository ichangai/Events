														...
														<div class="col-xl-9">
															...
															<div class="my-5 step">
																<div class="top_details">
																	<h5 class="text-dark font-weight-bold mb-10">ADD USER DETAILS:</h5>
																</div>
																{{-- @if($errors->any())
																...
																<div class="form-group row">
																	...
																	<div class="col-lg-9 col-xl-9">
																		<input class="form-control form-control-solid form-control-lg" name="name" id="name" type="text" placeholder="Full Name" />
																...
																<div class="form-group row">
																	...
																	<div class="col-lg-9 col-xl-9">
																		<input class="form-control form-control-solid form-control-lg" name="email" id="email" type="email" placeholder="Email" />
																...
																<div class="form-group row">
																	...
																	<div class="col-lg-9 col-xl-9">
																		<div class="input-group input-group-solid input-group-lg">
																			...
																			<input type="text" class="form-control form-control-solid form-control-lg" name="phone" id="phone" placeholder="Phone" /> <br />
																...
																<button  type="submit" id="regBtn" class="btn btn-success font-weight-bolder px-10 py-3" style="float: right;">Submit</button>
															</div>
															<!--end::Wizard Step 1-->
