        ...
        <div class="card card-custom my-5">
            ...
            <div class="card-header border-0 pt-7">
                <h3 class="card-title align-items-start flex-column">
                    <span class="card-label font-weight-bolder font-size-h4 text-dark-75">All Brokers</span>
                </h3>
            </div>
            <!--end::Header-->
            <!--begin::Body-->
...
@section('scripts')
    ...
    <script>
        ...
        $('.dltBtn').click(function(e) {
            ...
            swal({
                    title: "Are you sure?",
                    text: "Once deleted, you will not be able to recover the broker!",
                    icon: "warning",
                    buttons: true,
                    dangerMode: true,
                })
                .then((willDelete) => {
                    if (willDelete) {
                        ...
                        swal("The broker has not been deleted!");
                    }
                });
        });
    </script>
