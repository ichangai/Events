...
@section('content')
                ...
                <div class="card card-custom gutter-b card-stretch">
                    ...
                    <div class="card-header border-0 pt-6">
                        <h3 class="card-title align-items-start flex-column">
                            <span class="card-label font-weight-bolder font-size-h4 text-dark-75">Sponsor Name:
                                {{ $sponsor->name }}</span>
                            @php
                    ...
                    <div class="card-body">
                        ...
                        <div class="">
                            ...
                            <!--begin::Location-->
                            <h4 class="text-dark-75 text-hover-primary font-weight-bold" style="font-size: 14px;">Contact:
                                {{ $sponsor->contact }}</h4>
                            <!--end::Location-->

                            <!--begin::Location-->
                            <h4 class="text-dark-75 text-hover-primary font-weight-bold" style="font-size: 14px;">Email:
                                {{ $sponsor->email }}</h4>
                            <!--end::Location-->
                            ...
                            <div class="pt-2"
                                ...
                                <form action="{{ route('admin.sponsor.delete', $sponsor->id) }}" method="post"> @csrf
                                    @method('delete') <a type="submit"
                                        class="dltBtn btn btn-primary font-weight-bolder py-2"
                                        data-id="{{ $sponsor->id }}">Delete</a>
                                </form>
                            </div>
                        </div>
                        <!--end::Container-->
    ...
    <div style="display:flex; justify-content:center; align-items:stretch; padding: 300px 0;">
        <h3 style="color: rgba(128, 128, 128, 0.63);">No sponsors available</h3>
    </div>
    @endforelse
@endsection
