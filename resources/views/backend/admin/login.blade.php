			...
			<div class="login login-2 login-signin-on d-flex flex-column flex-column-fluid bg-white position-relative overflow-hidden" id="kt_login">
				...
				<div class="login-body d-flex flex-column-fluid align-items-stretch justify-content-center">
					<div class="container row">
								...
								<form action="{{ route('admin.check') }}"  method="POST">
									...
									<div class="form-group">
										<div class="d-flex justify-content-between mt-n5">
											...
											<a href="{{ route('admin.forgot') }}" class="text-primary font-size-h6 font-weight-bolder text-hover-primary pt-5" id="kt_login_forgot">Forgot Password ?</a>
										</div>
						...
						<div class="col-lg-6 bgi-size-contain bgi-no-repeat bgi-position-y-center bgi-position-x-center min-h-150px mt-10 m-md-0" style="background-image: url({{ asset('backend/assets/media/img/sisitales_author.png') }})" style="width: 200px;"></div>
					</div>
				</div>
				<!--end::Body-->
				<!--begin::Footer-->
